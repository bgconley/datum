...
export function CommandPalette() {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-[rgba(27,36,49,0.5)]" onClick={close}>
      <div
        className="mx-auto mt-[160px] w-[600px]"
        onClick={(event) => event.stopPropagation()}
      >
        <Command className="flex h-[480px] flex-col overflow-hidden rounded-[4px] border border-[#e1e8ed] bg-white shadow-[0px_8px_30px_0px_rgba(0,0,0,0.25)]">
          {/* Blue header */}
