...
write_env_var "DATUM_EMBEDDING_PROTOCOL" "qwen3_embedder"
...
write_env_var "DATUM_RERANKER_PROTOCOL" "qwen3_reranker"
write_env_var "DATUM_NER_ENDPOINT" "http://${HOST_IP}:8012"
write_env_var "DATUM_NER_MODEL" "knowledgator/gliner-bi-large-v2.0"
write_env_var "DATUM_NER_PROTOCOL" "gliner_http"
write_env_var "DATUM_LLM_ENDPOINT" "http://${HOST_IP}:11434"
write_env_var "DATUM_LLM_MODEL" "gpt-oss:20b"
...
echo "Model endpoints: embed=http://${HOST_IP}:8010 rerank=http://${HOST_IP}:8011 ner=http://${HOST_IP}:8012 llm=http://${HOST_IP}:11434"
echo "Pip packages:"
